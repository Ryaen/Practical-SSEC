...
class Editor extends React.Component {
    ...
    constructor(props) {
            ...
            class AddNumbers
            {
               public static void main(String args[])
               {
                 ...
                 // System.out.println("Enter two integers to calculate their sum");
                  ...
                  System.out.print(Integer.parseInt(x[0])+Integer.parseInt(x[1]));
               }
            }`,
            theme: 'monokai',
            mode: 'java',
        ...
        this.checkCases = this.checkCases.bind(this);
    ...
    codeSubmit(){
       ...
       const BACKURL = `https://extractible-meet.000webhostapp.com/App/getcases.php?id=1`;
        axios.get(BACKURL,{}).then((res)=>{
        //on success 
        console.log('cases',res.data);
        var testCases = res.data;
        testCases.forEach(this.checkCases);
